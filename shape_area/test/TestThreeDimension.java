...
public class TestThreeDimension {
    ...
    //
     ...
     public void Calc_SArea_Cube() {
        assertEquals(2400,thd.Calc_SArea_Cube(20),0.1);
        assertEquals(181.5,thd.Calc_SArea_Cube(5.5),0.1);
        assertEquals(937.5,thd.Calc_SArea_Cube(12.5),0.1);
        assertEquals(294,thd.Calc_SArea_Cube(7),0.1);
     }
      @Test
     public void Calc_SArea_Cuboid() {
        assertEquals(862,thd. Calc_SArea_Cuboid(11,12,13),0.1);
        assertEquals(26.6,thd. Calc_SArea_Cuboid(1.1,2.2,3.3),0.1);
        assertEquals(570,thd. Calc_SArea_Cuboid(5,10.5,15),0.1);
        assertEquals(384,thd. Calc_SArea_Cuboid(8,8,8),0.1);
     }
      @Test
     public void Calc_SArea_Triangular_Prism() {
        assertEquals(1770.8,thd.Calc_SArea_Triangular_Prism(10,20,30),0.1);
        assertEquals(708.2,thd.Calc_SArea_Triangular_Prism(5.5, 12.5, 20.2),0.1);
        assertEquals(262.9,thd.Calc_SArea_Triangular_Prism(4.4,5,15),0.1);
        assertEquals(163.5,thd.Calc_SArea_Triangular_Prism(5,6,7.1),0.1);
     }
     @Test
     public void Calc_SArea_Cylinder() {
        assertEquals(471.3,thd.Calc_SArea_Cylinder(5,10),0.1);
        assertEquals(33.17,thd.Calc_SArea_Cylinder(1.1, 3.7),0.1);
        assertEquals(1693.3,thd.Calc_SArea_Cylinder(11, 13.5),0.1);
        assertEquals(5301.4,thd.Calc_SArea_Cylinder(22.5, 15),0.1);
     }
     @Test
     public void Calc_SArea_Cone() {
        assertEquals(867.96,thd.Calc_SArea_Cone(5,50),1);
        assertEquals(933.77,thd.Calc_SArea_Cone(10, 17),1);
     ...
     public void Calc_SArea_Sphere() {
        assertEquals(7854,thd.Calc_SArea_Sphere(25),1);
